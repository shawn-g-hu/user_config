...
argglobal
%argdel
$argadd pointpillars_object_detector.cc
set stal=2
tabnew
tabrewind
...
wincmd w
argglobal
if bufexists("pointpillars_object_detector.cc") | buffer pointpillars_object_detector.cc | else | edit pointpillars_object_detector.cc | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe '3resize ' . ((&lines * 19 + 30) / 60)
tabnext
edit ../include/multidimensional_vector_interface.h
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
25
normal! zo
let s:l = 65 - ((15 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
...
wincmd w
argglobal
if bufexists("../include/voxelizer.h") | buffer ../include/voxelizer.h | else | edit ../include/voxelizer.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
125
normal! zo
let s:l = 126 - ((9 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
126
...
111
normal! zo
let s:l = 114 - ((14 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
114
...
tabnext 1
set stal=1
badd +0 pointpillars_object_detector.cc
badd +67 ../include/multidimensional_vector_interface.h
badd +76 voxelizer.cc
badd +0 ../include/voxelizer.h
badd +0 ../include/pointpillars_object_detector.ho
badd +0 ../include/pointpillars_object_detector.h
badd +17 ../include/tf_image_model.h
badd +28 ../include/tf_model.h
badd +223 tf_image_model.cc
badd +64 tf_model.cc
