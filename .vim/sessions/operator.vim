...
silent only
cd ~/drive/tools/ros_runtime/src/demo_renderer/scripts
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 visualizer.py
badd +0 operator.py
badd +0 ros_listener.py
argglobal
silent! argdel *
argadd visualizer.py
edit operator.py
...
78
normal! zo
let s:l = 122 - ((9 * winheight(0) + 9) / 19)
...
935
normal! zo
let s:l = 104 - ((9 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
104
...
48
normal! zo
let s:l = 202 - ((9 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
202
