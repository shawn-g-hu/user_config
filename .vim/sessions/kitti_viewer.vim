...
silent only
cd /root/second/second
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +294 kittiviewer/backend.py
badd +154 kittiviewer/frontend/js/KittiViewer.js
badd +1 kittiviewer/frontend/index.html
badd +42 kittiviewer/frontend/js/SimplePlot.js
badd +369 pytorch/core/box_torch_ops.py
badd +1 ~/plusai_kitti/training/calib/000000
badd +1 ~/plusai_kitti/training/calib/20180808T112518_unknown_auto_0.trimmed.bag_frame00000.txt
badd +1 ~/Kitti/training/calib/000000.txt
badd +3 ~/run_unified_sim_thor.sh
argglobal
silent! argdel *
argadd kittiviewer/backend.py
set stal=2
edit kittiviewer/backend.py
...
let s:l = 306 - ((24 * winheight(0) + 14) / 28)
...
246
normal! zo
let s:l = 272 - ((21 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
272
...
exe '1resize ' . ((&lines * 28 + 30) / 60)
exe '2resize ' . ((&lines * 28 + 30) / 60)
tabedit kittiviewer/frontend/index.html
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
61
normal! zo
let s:l = 214 - ((9 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
214
...
wincmd w
argglobal
edit kittiviewer/frontend/js/KittiViewer.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 158 - ((10 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
158
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 142 - ((6 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
142
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 243 - ((5 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
243
...
exe '3resize ' . ((&lines * 14 + 30) / 60)
exe '4resize ' . ((&lines * 13 + 30) / 60)
tabedit kittiviewer/frontend/js/KittiViewer.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 291 - ((13 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
291
normal! 05|
tabedit kittiviewer/frontend/js/SimplePlot.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 37 - ((8 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
...
245
normal! zo
let s:l = 250 - ((53 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
250
normal! 046|
tabedit ~/Kitti/training/calib/000000.txt
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
wincmd w
argglobal
edit ~/plusai_kitti/training/calib/20180808T112518_unknown_auto_0.trimmed.bag_frame00000.txt
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit pytorch/core/box_torch_ops.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 362 - ((3 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
362
...
246
normal! zo
let s:l = 134 - ((3 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
134
