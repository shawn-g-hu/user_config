...
argglobal
%argdel
$argadd plusai_models/src/pointpillars_object_detector.cc
set stal=2
tabnew
tabnew
tabnew
tabnew
tabrewind
edit plusai_models/include/tf_model.h
...
wincmd w
argglobal
if bufexists("plusai_models/include/pointpillars_object_detector.h") | buffer plusai_models/include/pointpillars_object_detector.h | else | edit plusai_models/include/pointpillars_object_detector.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
43
normal! zo
let s:l = 27 - ((15 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
wincmd w
argglobal
if bufexists("plusai_models/src/pointpillars_object_detector.cc") | buffer plusai_models/src/pointpillars_object_detector.cc | else | edit plusai_models/src/pointpillars_object_detector.cc | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
normal! 09|
tabnext
edit test/run_mask_object_detector.cc
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
wincmd w
argglobal
if bufexists("test/run_pointpillars_object_detector.cc") | buffer test/run_pointpillars_object_detector.cc | else | edit test/run_pointpillars_object_detector.cc | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 49 - ((13 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
wincmd w
argglobal
if bufexists("test/test_utils.cc") | buffer test/test_utils.cc | else | edit test/test_utils.cc | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
64
normal! zo
let s:l = 58 - ((9 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
...
tabnext 3
set stal=1
badd +34 plusai_models/src/pointpillars_object_detector.cc
badd +0 plusai_models/include/tf_model.h
badd +0 test/test_pointpillars_object_detector.cc
badd +0 plusai_models/include/pointpillars_object_detector.h
badd +47 test/run_mask_object_detector.cc
badd +0 test/run_pointpillars_object_detector.cc
badd +0 test/test_utils.
badd +0 test/test_utils.cc
badd +0 test/test_utils.h
badd +26 plusai_models/hide_symbols.lds
