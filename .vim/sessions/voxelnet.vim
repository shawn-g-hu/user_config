...
set shortmess=aoO
badd +78 pytorch/train.py
badd +5 ~/SECOND/torchplus/train/common.py
badd +173 ~/SECOND/torchplus/train/checkpoint.py
badd +0 ~/SECOND/torchplus/train/optim.py
badd +0 pytorch/builder/se
badd +0 pytorch/builder/second_builder.pys
badd +20 pytorch/builder/second_builder.py
badd +20 pytorch/models/voxelnet.py
badd +1 configs/car.fhd.config
badd +224 pytorch/models/voxel_encoder.py
argglobal
silent! argdel *
argadd pytorch/train.py
set stal=2
edit ~/SECOND/torchplus/train/optim.py
...
wincmd w
argglobal
edit ~/SECOND/torchplus/train/checkpoint.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
144
normal! zo
let s:l = 141 - ((4 * winheight(0) + 5) / 11)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
141
...
144
normal! zo
let s:l = 117 - ((5 * winheight(0) + 5) / 10)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
117
...
144
normal! zo
let s:l = 148 - ((6 * winheight(0) + 5) / 11)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
148
...
exe '4resize ' . ((&lines * 10 + 30) / 60)
exe '5resize ' . ((&lines * 11 + 30) / 60)
tabedit pytorch/builder/second_builder.py
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
110
normal! zo
let s:l = 125 - ((4 * winheight(0) + 5) / 11)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
...
237
normal! zo
let s:l = 239 - ((3 * winheight(0) + 5) / 10)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
239
...
exe '4resize ' . ((&lines * 11 + 30) / 60)
exe '5resize ' . ((&lines * 10 + 30) / 60)
tabedit configs/car.fhd.config
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
wincmd w
argglobal
edit pytorch/models/voxelnet.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
694
normal! zo
let s:l = 278 - ((3 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
278
...
694
normal! zo
let s:l = 139 - ((10 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
139
...
694
normal! zo
let s:l = 296 - ((9 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
296
...
exe '3resize ' . ((&lines * 14 + 30) / 60)
exe '4resize ' . ((&lines * 13 + 30) / 60)
tabedit pytorch/models/voxel_encoder.py
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
wincmd w
argglobal
edit pytorch/models/voxel_encoder.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
134
normal! zo
let s:l = 101 - ((8 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
101
...
134
normal! zo
let s:l = 222 - ((11 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
222
